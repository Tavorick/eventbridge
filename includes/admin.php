...
class EventBridge_Admin {
	...
	private function render_condition_row( $condition, $index, $catalog, $locked ) {
		...
		$base     = 'eventbridge_event[conditions][' . $index . ']';
