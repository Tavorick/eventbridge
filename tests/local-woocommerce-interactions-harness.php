...
$woo        = new EventBridge_WooCommerce( $dispatcher, $log, $conditions );
$events     = new EventBridge_Events( $woo, $conditions );
$woo->set_events( $events );
$fluent     = new EventBridge_Fluent_Booking();
$interactions = new EventBridge_WooCommerce_Interactions( $events, $dispatcher, $log, $conditions, $fluent );
